...
При создании гетерогенной среды виртуализации повышаются требования к обслуживающему персоналу, вместо одной системы приходится обслуживать две или более. Подходы к их обслуживанию могут быть значительно отличаться, что в некоторых организациях могут вызвать путаницу в зависимости от используемых технологий и квалификации персонала.
